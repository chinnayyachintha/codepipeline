...
resource "aws_s3_bucket_ownership_controls" "replication_ownership" {
  provider = aws.replication
  bucket   = aws_s3_bucket.replication_bucket.id
...
resource "aws_s3_bucket_ownership_controls" "codepipeline_ownership" {
  bucket = aws_s3_bucket.codepipeline_bucket.id
